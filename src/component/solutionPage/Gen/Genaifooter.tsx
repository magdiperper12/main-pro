        ...
        <div className='sm:rounded-0 text-center'>
          ...
          <div>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-extrabold mt-5   '>
              Customized Solutions for Your Unique Needs with Botbat Generative
              AI Power{" "}
            </h1>
            <p className='text-lg md:text-xl lg:text-2xl mt-5 mx-auto max-w-5xl'>
              Don't miss the opportunity to elevate your business. Start now and
              discover the unlimited possibilities that Generative AI offers for
