      ...
      <div className='container mx-auto text-center'>
        <div className='sm:rounded-0 text-center'>
          ...
          <div className='w-full '>
            ...
            <p className='text-base md:text-lg lg:text-xl mt-5 md:w-3/4 text-center  mx-5 md:mx-auto m-auto'>
          ...
          {/* Buttons */}
          <div className='mt-10 md:mt-10 flex flex-col md:flex-row justify-center items-center mx-3 md:mx-0 lg:mx-0 gap-5'>
