...
function CallToSubscribe() {
  return (
    <div className=" pb-10 md:pb-20 pt-4 md:pt-0 md:py-8   lg:mt-16">
      <div className="container mx-auto text-center">
        <div className="sm:rounded-0 text-center">
          {/* Header of the page */}
          <div className="w-full ">
            <h1 className="text-xl md:text-3xl lg:text-4xl w-10/12 md:w-3/4  m-auto font-extrabold mt-5 ">
              Begin with Botbat for Cost-Effective Multichannel Messaging
            </h1>
            <p className="text-base md:text-lg lg:text-xl mt-2 md:mt-3 md:w-3/4 text-center  mx-5 md:mx-auto m-auto">
          ...
          {/* Buttons */}
          <div className="mt-4 md:mt-5 flex flex-col md:flex-row justify-center items-center mx-3 md:mx-0 lg:mx-0 gap-5">
