        ...
        <div className='container mx-auto md:px-5 md:py-2 lg:px-32 lg:pt-12'>
          <div className='flex flex-wrap -m-2'>
            <div className='w-full md:w-1/2 p-2 text-left mt-15'>
              <button className='w-full border-s-0  text-start hover:shadow-lg border-blue-900 p-4 md:mt-10 mt-2 transition duration-300 ease-in-out focus:border-s-4 '>
              ...
              <button className='w-full border-s-0 hover:shadow-lg border-blue-900 p-4 md:mt-10 mt-2 transition duration-300 ease-in-out focus:border-s-4 text-start'>
                <h1 className='text-xl md:text-2xl font-bold mb-1'>
                  Short heading goes here
                </h1>
                <p className='text-sm'>
