      ...
      <section className=' '>
        <div className='container mx-auto px-0 lg:px-4 md:px-4 sm:px-0'>
          <div className='text-center pb-10'>
            <h1 className='text-xl md:text-3xl lg:text-5xl w-10/12 md:w-9/12 lgw-8/12 m-auto font-extrabold mt-5 leading-tight '>
              {theheader}
            </h1>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-10 items-start lg:w-11/12 m-auto px-4 lg:px-20 '>
