        ...
        <div className="flex w-full sm:w-full md:w-1/2 lg:w-1/2 order-1 md:order-2 rtl:order-1 ">
          <div className="w-full p-2 md:p-4 mx-1 md:mx-0">
            ...
            <div className="mt-8 md:mt-10 flex flex-col md:flex-row justify-start gap-3  lg:gap-5 mx-1 md:mx-0">
              <button className="bg-blue-700 hover:bg-blue-800 text-white rounded-md py-3  md:py-4 w-full  lg:w-1/2 md:w-1/2 transition duration-300 ease-in-out text-lg font-bold lg:text-xl sm:text-lg m-auto text-nowrap">
                {button}
              </button>
              <button className="bg-white hover:bg-blue-50 text-blue-900 border border-blue-600 rounded-md py-3  md:py-4 w-full lg:w-1/2 md:w-1/2 transition duration-300 ease-in-out text-lg font-bold lg:text-xl sm:text-lg  m-auto text-nowrap">
                {secondButton}
              </button>
            </div>
          </div>
