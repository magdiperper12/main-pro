    ...
    <div className="bg-slate-600 text-white relative">
      <div className="container flex w-11/12 text-center mx-auto">
        <div className="w-full p-4">
          <div className="mt-3 md:mt-5 flex flex-col md:flex-row items-center justify-between">
            <div className="py-2   w-full lg:w-1/2">
              ...
              <div className="mt-6 lg:mt-12 flex flex-row gap-2">
                <input
              ...
              <div className="flex justify-center gap-4 my-4 lg:my-10">
                <FaInstagram className="h-9 w-9 pe-2" />
                <FaWhatsapp className="h-9 w-9 pe-2" />
                <FaFacebook className="h-9 w-9 pe-2" />
                <FaYoutube className="h-9 w-9 pe-2" />
                <FaLinkedin className="h-9 w-9 pe-2" />
                <FaTwitter className="h-9 w-9 pe-2" />
              </div>
            </div>
