...
function FacebookMessengerfooter() {
  return (
        ...
        <div className='sm:rounded-0 text-center'>
          ...
          <div>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-extrabold mt-5   '>
              Enhance your business with AI-driven chatbots
            </h1>
            <p className='text-lg md:text-xl lg:text-2xl mt-5 mx-auto max-w-5xl'>
              Boost sales and efficiency with advanced AI chatbots for
...
export default FacebookMessengerfooter;
