        ...
        <div className='flex w-full sm:w-full md:w-1/2 lg:w-1/2 order-1 md:order-2 rtl:order-1 '>
          <div className='w-full p-2 md:p-4'>
            <h1 className='text-4xl md:text-6xl font-bold mt-10 '>
              Leading Comprehensive Digital Transformation for Governments
            </h1>
            <p className='text-lg md:text-xl mt-6'>
              We help governments improve efficiency and deliver high-quality
              government services to citizens through comprehensive and
