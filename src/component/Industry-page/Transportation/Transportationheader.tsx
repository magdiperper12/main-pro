        ...
        <div className='flex w-full sm:w-full md:w-1/2 lg:w-1/2 order-1 md:order-2 rtl:order-1 '>
          <div className='w-full p-2 md:p-4'>
            <h1 className='text-4xl md:text-6xl font-bold mt-10 '>
              Professional Servicesto Enhance Your Operational Performance
            </h1>
            <p className='text-lg md:text-xl mt-6'>
              Elevate your business operations through our advanced AI-powered
              professional services, custom-designed to meet your organization's
              unique needs
            </p>
