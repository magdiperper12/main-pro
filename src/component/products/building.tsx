...
function Building() {
    return (
      <div>
        <div className='flex item-center w-full my-24 lg:my-24 md:my-24 sm:my-24 px-0 lg:px-12 py-2 lg:pt-12 flex-wrap mx-auto'>
          <div className='flex w-full sm:w-full md:w-1/2 lg:w-1/2 order-1 md:order-2 rtl:order-1 '>
            <div className='w-full p-2 md:p-4'>
              ...
              <p className='text-lg md:text-xl mt-6'>
                {" "}
               Sign Up d start building your ideal customer engagement exprience today
              </p>
              <div className='mt-8 md:mt-10 flex flex-col md:flex-row justify-start gap-5'>
                ...
                <button className='bg-white hover:bg-blue-50 text-blue-900 border px-0 lg:px-10 md:px-10 sm:px-0 border-blue-600 rounded-md py-3 md:px-6 md:py-4 w-full lg:w-1/2 md:w-1/2 transition duration-300 ease-in-out '>
                 see pricing
                </button>
              </div>
            </div>
